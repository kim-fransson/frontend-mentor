...
export const AverageDisplay = (props: AverageDisplayProps) => {
  ...
  return (
    <div className="gap-2 md:gap-1 rounded-full inline-flex items-center justify-center flex-col w-36 h-36 md:w-44 md:h-44 bg-gradient-to-b from-indigo-800  to-indigo-600">
